...
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\AddBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\AndBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\BitwiseAndBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\BitwiseOrBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\BitwiseXorBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\ConcatBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\DivBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\EndsWithBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\EqualBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\FloorDivBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\GreaterBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\GreaterEqualBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\HasEveryBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\HasSomeBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\InBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\LessBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\LessEqualBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\MatchesBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\ModBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\MulBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\NotEqualBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\NotInBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\OrBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\PowerBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\RangeBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\SpaceshipBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\StartsWithBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Binary\SubBinary;
use WpifyMapyCzDeps\Twig\Node\Expression\Filter\DefaultFilter;
use WpifyMapyCzDeps\Twig\Node\Expression\NullCoalesceExpression;
use WpifyMapyCzDeps\Twig\Node\Expression\Test\ConstantTest;
use WpifyMapyCzDeps\Twig\Node\Expression\Test\DefinedTest;
use WpifyMapyCzDeps\Twig\Node\Expression\Test\DivisiblebyTest;
use WpifyMapyCzDeps\Twig\Node\Expression\Test\EvenTest;
use WpifyMapyCzDeps\Twig\Node\Expression\Test\NullTest;
use WpifyMapyCzDeps\Twig\Node\Expression\Test\OddTest;
use WpifyMapyCzDeps\Twig\Node\Expression\Test\SameasTest;
use WpifyMapyCzDeps\Twig\Node\Expression\Unary\NegUnary;
use WpifyMapyCzDeps\Twig\Node\Expression\Unary\NotUnary;
use WpifyMapyCzDeps\Twig\Node\Expression\Unary\PosUnary;
use WpifyMapyCzDeps\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use WpifyMapyCzDeps\Twig\TokenParser\ApplyTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\BlockTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\DeprecatedTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\DoTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\EmbedTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\ExtendsTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\FlushTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\ForTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\FromTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\IfTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\ImportTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\IncludeTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\MacroTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\SetTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\UseTokenParser;
use WpifyMapyCzDeps\Twig\TokenParser\WithTokenParser;
...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            // formatting filters
            new TwigFilter('date', 'WpifyMapyCzDeps\twig_date_format_filter', ['needs_environment' => \true]),
            new TwigFilter('date_modify', 'WpifyMapyCzDeps\twig_date_modify_filter', ['needs_environment' => \true]),
            new TwigFilter('format', 'WpifyMapyCzDeps\twig_sprintf'),
            new TwigFilter('replace', 'WpifyMapyCzDeps\twig_replace_filter'),
            new TwigFilter('number_format', 'WpifyMapyCzDeps\twig_number_format_filter', ['needs_environment' => \true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', 'WpifyMapyCzDeps\twig_round'),
            // encoding
            new TwigFilter('url_encode', 'WpifyMapyCzDeps\twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', 'WpifyMapyCzDeps\twig_convert_encoding'),
            // string filters
            new TwigFilter('title', 'WpifyMapyCzDeps\twig_title_string_filter', ['needs_environment' => \true]),
            new TwigFilter('capitalize', 'WpifyMapyCzDeps\twig_capitalize_string_filter', ['needs_environment' => \true]),
            new TwigFilter('upper', 'WpifyMapyCzDeps\twig_upper_filter', ['needs_environment' => \true]),
            new TwigFilter('lower', 'WpifyMapyCzDeps\twig_lower_filter', ['needs_environment' => \true]),
            new TwigFilter('striptags', 'WpifyMapyCzDeps\twig_striptags'),
            new TwigFilter('trim', 'WpifyMapyCzDeps\twig_trim_filter'),
            new TwigFilter('nl2br', 'WpifyMapyCzDeps\twig_nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', 'WpifyMapyCzDeps\twig_spaceless', ['is_safe' => ['html']]),
            // array helpers
            new TwigFilter('join', 'WpifyMapyCzDeps\twig_join_filter'),
            new TwigFilter('split', 'WpifyMapyCzDeps\twig_split_filter', ['needs_environment' => \true]),
            new TwigFilter('sort', 'WpifyMapyCzDeps\twig_sort_filter', ['needs_environment' => \true]),
            new TwigFilter('merge', 'WpifyMapyCzDeps\twig_array_merge'),
            new TwigFilter('batch', 'WpifyMapyCzDeps\twig_array_batch'),
            new TwigFilter('column', 'WpifyMapyCzDeps\twig_array_column'),
            new TwigFilter('filter', 'WpifyMapyCzDeps\twig_array_filter', ['needs_environment' => \true]),
            new TwigFilter('map', 'WpifyMapyCzDeps\twig_array_map', ['needs_environment' => \true]),
            new TwigFilter('reduce', 'WpifyMapyCzDeps\twig_array_reduce', ['needs_environment' => \true]),
            // string/array filters
            new TwigFilter('reverse', 'WpifyMapyCzDeps\twig_reverse_filter', ['needs_environment' => \true]),
            new TwigFilter('length', 'WpifyMapyCzDeps\twig_length_filter', ['needs_environment' => \true]),
            new TwigFilter('slice', 'WpifyMapyCzDeps\twig_slice', ['needs_environment' => \true]),
            new TwigFilter('first', 'WpifyMapyCzDeps\twig_first', ['needs_environment' => \true]),
            new TwigFilter('last', 'WpifyMapyCzDeps\twig_last', ['needs_environment' => \true]),
            // iteration and runtime
            new TwigFilter('default', 'WpifyMapyCzDeps\_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', 'WpifyMapyCzDeps\twig_get_array_keys_filter'),
        ];
    }
...
use WpifyMapyCzDeps\Twig\Extension\CoreExtension;
use WpifyMapyCzDeps\Twig\Extension\SandboxExtension;
use WpifyMapyCzDeps\Twig\Markup;
use WpifyMapyCzDeps\Twig\Source;
use WpifyMapyCzDeps\Twig\Template;
use WpifyMapyCzDeps\Twig\TemplateWrapper;
/**
 * Cycles over a value.
 *
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('WpifyMapyCzDeps\\Twig\\Extension\\SandboxExtension') && $env->getExtension('WpifyMapyCzDeps\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
