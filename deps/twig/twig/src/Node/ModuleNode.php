 ...
 */
namespace WpifyMapyCzDeps\Twig\Node;
...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        $compiler->write("\n\n");
        if (!$this->getAttribute('index')) {
            $compiler->write("use WpifyMapyCzDeps\\Twig\\Environment;\n")->write("use WpifyMapyCzDeps\\Twig\\Error\\LoaderError;\n")->write("use WpifyMapyCzDeps\\Twig\\Error\\RuntimeError;\n")->write("use WpifyMapyCzDeps\\Twig\\Extension\\SandboxExtension;\n")->write("use WpifyMapyCzDeps\\Twig\\Markup;\n")->write("use WpifyMapyCzDeps\\Twig\\Sandbox\\SecurityError;\n")->write("use WpifyMapyCzDeps\\Twig\\Sandbox\\SecurityNotAllowedTagError;\n")->write("use WpifyMapyCzDeps\\Twig\\Sandbox\\SecurityNotAllowedFilterError;\n")->write("use WpifyMapyCzDeps\\Twig\\Sandbox\\SecurityNotAllowedFunctionError;\n")->write("use WpifyMapyCzDeps\\Twig\\Source;\n")->write("use WpifyMapyCzDeps\\Twig\\Template;\n\n use function WpifyMapyCzDeps\\twig_escape_filter; \n\n");
        }
