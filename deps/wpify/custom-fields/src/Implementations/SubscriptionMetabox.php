...
namespace WpifyMapyCzDeps\Wpify\CustomFields\Implementations;

use WpifyMapyCzDeps\Automattic\WooCommerce\Admin\Overrides\Order;
use WpifyMapyCzDeps\Automattic\WooCommerce\Internal\DataStores\Orders\CustomOrdersTableController;
use WP_Post;
use WP_Screen;
...
class SubscriptionMetabox extends AbstractPostImplementation
{
    ...
    public function save($post_id)
    {
        ...
        if (\defined('WpifyMapyCzDeps\\DOING_AUTOSAVE') && DOING_AUTOSAVE) {
            return $post_id;
        }
